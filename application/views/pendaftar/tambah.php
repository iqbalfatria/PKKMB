		...
		<?php if ($this->session->flashdata('berhasil_simpan')) { ?>
		 ...
		 <?php } ?>
		<?php echo form_open_multipart(base_url('pendaftar/tambah'), 'class="form-horizontal"' ); ?>
            ...
            <div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="warga_negara" class="form-control" placeholder="Isi Warga Negara Anda" required="">
				</div>
			</div>
			<div class="form-group">
            ...
            <div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="email_siswa" class="form-control" placeholder="Isi Email Anda" required="">
				</div>
			</div>
			<div class="form-group">
